...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: "Live Stage Design",
    tier: "agency",
    brandColor: "#E63946",
    hotspot: { x: 93, y: 27.03 },
    heroImage: "/projects/vince-staples-coachella/hero.jpg",
    writeup: "Vince Staples headlined Coachella in 2018, and he had an epic stage setup, a wall of mismatched television screens that looked like a basement collage. He just needed some help figuring out what to put on them.",
    credits: "",
    carousel: [
  ...
  },
  {
    ...
    writeup: "I'm currently a Creative Director at TBWA\\Chiat\\Day on the Gatorade team, partnered with the illustrious Evan Chiplock.\n\nBefore that, I worked at MullenLowe, The Many, Anomaly, and even started out in the mailroom at CAA. And yes, I have seen sandwiches thrown at terminal velocity toward a coworker.\n\nI've held the title of art director over the years, but I write too. Reading, watching, experiencing, writing, making, and telling stories, however they take form, is what drives me.\n\nI can show you better than I can tell you, though. Which is why you're here, in my room. Sort of.\n\nRight now I'm working on Gatorade. Before that, I worked on Acura, eBay, Canada Goose, AB InBev, Eva Longoria, Vince Staples, and a singer who now shares the stage with a Cheetah puppet.\n\nI've made campaigns, films, objects, experiments, strange little internet things, and a few things that were probably giving, \"name one thing in this room.\"\n\nAnyways...\n\nThe goal is simple:\n\nMake shit that lives in the halls of reference, and have fun doing it.\n\nSo let's run it up.\nCam",
    carousel: [],
    vimeoUrl: null,
